...
- "剪贴板识别" / "剪贴板图片" / "剪贴板里有什么" — 从剪贴板读取并识别图片
- "描述这张图片" / "图片里有什么内容？"
- "识别这个截图里的文字" / "提取图中的文本"
- "转写这段录音" / "这个音频说了什么？"
- "这个视频讲了什么？" / "总结一下视频内容"
